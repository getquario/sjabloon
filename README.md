...
- **Quick on runtime templates.** Compiling and rendering a fresh 10-row escaped template: ~103k ops/sec, about 7x Handlebars and a little behind Mustache. Code-generating engines win the hot-render loop instead — [the full table](bench/comparison/readme.md) shows both sides of the trade.
