...
- `test/browser/harness.js` resolves bare specifiers through an import map, not a source rewrite, and the CSP hash covers that map. Add a dependency to both the map and the route table.
